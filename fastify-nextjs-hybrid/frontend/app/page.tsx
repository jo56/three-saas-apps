    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <section className="container mx-auto px-4 py-24 text-center">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          ...
          and billing. Powered by Fastify backend with Next.js frontend.
        </p>
      ...
      <footer className="border-t mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Hybrid architecture with Fastify backend and Next.js frontend.
              </p>
            </div>
            <div>
          ...
          <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2024 SaaS Dashboard. Demo project showcasing Fastify + Next.js hybrid architecture.</p>
          </div>
        </div>
      </footer>
    </div>
