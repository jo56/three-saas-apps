    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <section className="container mx-auto px-4 py-24 text-center">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          ...
          and billing. Compare Next.js, Fastify, and hybrid architectures.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create, schedule, and share comprehensive reports with your team
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Tailor the platform to your needs with extensive configuration options
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
      ...
      <footer className="border-t mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold">SaaS Dashboard</span>
              </div>
              <p className="text-sm text-muted-foreground">
                Three architectural approaches: Next.js, Fastify+React, and Hybrid.
              </p>
            </div>
            <div>
          ...
          <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2024 SaaS Dashboard. Demo project showcasing Next.js SSG capabilities.</p>
          </div>
        </div>
      </footer>
    </div>
